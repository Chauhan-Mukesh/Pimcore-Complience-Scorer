 ...
 * - Displays per-dimension breakdown and severity summary badges.
 */
export const ReadinessPanel: React.FC<ReadinessPanelProps> = ({ objectId }) => {
    ...
    const { severityCounts, dimensionScores } = activeProfile;
        ...
        <div style={styles.panel}>
            ...
            <div style={styles.badges}>
                ...
                {errorCount === 0 && warningCount === 0 && infoCount === 0 && (
                    <span style={{ ...styles.badge, ...styles.badgeGood }}>✔ All checks passed</span>
                )}
            </div>

            <div style={styles.divider} />

            {/* Dimension breakdown (only shown when there are imperfect dimensions) */}
            ...
            <div style={styles.missingSection}>
                <h3 style={styles.sectionTitle}>
                    Missing Fields ({activeProfile.missingFields.length})
                </h3>
                <MissingFieldList
